...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2016 at 04:36 PM
...
CREATE TABLE `papers` (
  ...
  `draftFilename` varchar(255) NOT NULL,
  `firstReviewFilename` varchar(255) DEFAULT NULL,
  `revisedFilename` varchar(255) DEFAULT NULL,
  `finalReviewFilename` varchar(255) DEFAULT NULL,
...
(1, 'admin', '2016-08-19 00:00:00', '2016-09-27 09:33:12', 'Firstname', 'Lastname', NULL, 'admin@email.com', '$2y$10$pEPtxGEQCUWvu6CBfavyIeHxrZnZo.cDaCCkHzqzU7p.uKbESm4tS', 'admin'),
...
(5, 'user', '2016-08-21 04:34:55', '2016-09-27 09:33:35', 'first', 'last', 'ISU', 'email@email.com', '$2y$11$fSL8mjGwt/SSWhJKfFMIwuPOAiIqx4Wo6Hi8mTqyfFoZ2MA3vtD/y', 'author'),
...
--
ALTER TABLE `papers`
  MODIFY `paperID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
